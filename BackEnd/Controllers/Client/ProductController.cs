...
namespace BackEnd.Controllers.Client
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetProductsByCategory([FromQuery] string category, [FromQuery] int page = DEFAULT_PAGE_NUMBER, [FromQuery] int size = DEFAULT_SIZE_PER_PAGE)
        {
